...
def make_args():
    ...
    parser.add_argument('--use_actual_ind', action='store_true', help='use actual values of independent vars', default=None)
...
def main():   
    ...
    defaults = {
        ...
        'model': 'LSTM',
        'lstm_type': '',
        'data': 'IOPTQCfFiFoP_2min',
        'dataset_name': 'wastewater.csv',
        'setting': 'LSTM_IOPTQCfFiFoP_2min_15F_6Out_timeF_Unscaled_240Seq_0Label_16Batch_1e-06LR_256H_2L',
        'data_start': '2021-08-15 00:00:00+00:00',
        'data_end': '2021-08-16 00:00:00+00:00',
        'seq_length': 240, # 240, # changed
        'val_ratio': 0.05,
        'val_length': 60,
        'retrain_lr': 1e-6,
        'retrain_wd': 1e-9,
