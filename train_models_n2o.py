...
def make_args():
    ...
    args.data_path = 'DQAPTQN_Fredericia_2021_2022.csv'
    args.data_tag = 'DQAPTQN'
    args.target = 'N2O'
    args.ctrl_vars = ['Duty', 'Q_air', 'air_ON']
    args.ind_vars = ['pH', 'Temp', 'Q_in']
    args.num_time_f = 6
    args.loss = 'mse'
    args.dilate_all = True
    args.alpha_dilate = 0.6
    ...
    setting = 'N2O_{}{}_{}_{}F_{}Out_{}_{}_{}Seq{}_{}Label_{}Batch_{}LR_{}H_'.format(
