...
class EpisodeSampler:
    """Takes a full time-series tensor and yields (src, tgt) episodes for retraining.
    For now we just slide a fixed window; can be extended later."""
    ...
    def sample(self) -> Tuple[torch.Tensor, torch.Tensor]:
        # pick random start idx that fits
