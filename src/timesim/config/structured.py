...
class ModelConfig:
    ...
    min_scale: float = 0.5
    min_std: float = 0.5
    decoder_min_std: float = 0.5
    decoder_max_std: float = 2.0
...
def _as_model(model: Dict[str, Any]) -> ModelConfig:
    return ModelConfig(
        ...
        min_scale=float(model.get("min_scale", 0.5)),
        min_std=float(model.get("min_std", model.get("min_scale", 0.5))),
        decoder_min_std=float(model.get("decoder_min_std", model.get("min_std", model.get("min_scale", 0.5)))),
        decoder_max_std=float(model.get("decoder_max_std", model.get("max_std", 2.0))),
        prior_min_std=float(model.get("prior_min_std", 0.1)),
        prior_max_std=float(model.get("prior_max_std", 1.5)),
        posterior_min_std=float(model.get("posterior_min_std", 0.1)),
        posterior_max_std=float(model.get("posterior_max_std", 1.5)),
