...
from timesim.data.dataset import GroupedTimeSeriesDataset, TimeSeriesDataset
...
def test_dataset_nan_detection():
    ...
    with pytest.raises(ValueError, match="NaNs detected while fitting normalization stats"):
